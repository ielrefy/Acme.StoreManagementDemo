...
public class StoreManagementDemoDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public StoreManagementDemoDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
