...
public static class StoreManagementDemoEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE StoreManagementDemoModuleExtensionConfigurator CLASS (in the Domain.Shared project)
